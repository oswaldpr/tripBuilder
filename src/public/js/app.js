...
__webpack_require__(/*! ./tripBuilder */ "./resources/js/tripBuilder.js");
...
/* harmony export */   "axiosOperation": () => (/* binding */ axiosOperation)
/* harmony export */ });
...
function axiosOperation(serviceRoute) {
  var serviceData = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var params = new URLSearchParams();

  if (serviceData) {
    for (var _i = 0, _Object$entries = Object.entries(serviceData); _i < _Object$entries.length; _i++) {
  ...
  })["finally"](function (e) {// Finally opp
  });
}
